#ifdef __APPLE__
  #define WILDSTACKS_LOCAL_SYMBOL(x) .private_extern x
#else
  #define WILDSTACKS_LOCAL_SYMBOL(x) .hidden x
#endif
...
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
WILDSTACKS_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
